...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/app-icon-192.jpg', sizes: '192x192', type: 'image/jpeg' },
      { url: '/app-icon-512.jpg', sizes: '512x512', type: 'image/jpeg' },
    ],
    apple: [
      { url: '/app-icon-192.jpg', sizes: '180x180', type: 'image/jpeg' },
    ],
  },

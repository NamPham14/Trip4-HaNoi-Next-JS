...
export const metadata: Metadata = {
  title: "Đăng ký | Trip4Hanoi",
  description: "Tạo tài khoản Trip4Hanoi mới",
};
...
export default function RegisterPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-hanoi-cream">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-hanoi-gold/20 blur-3xl" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-hanoi-red/10 blur-3xl" />

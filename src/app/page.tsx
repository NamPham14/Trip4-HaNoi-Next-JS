    ...
    <div className="min-h-screen bg-hanoi-cream selection:bg-hanoi-red selection:text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-12 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-white/80 text-lg md:text-xl mb-12 font-medium leading-relaxed px-4 animate-fade-in-up">
            Trải nghiệm hành trình du lịch thông minh, nơi di sản ngàn năm giao
            thoa cùng công nghệ tương lai.
          </p>
        ...
        <div className="absolute bottom-10 left-10 hidden lg:block animate-bounce-slow">
          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md p-4 rounded-3xl border border-white/10">
            ...
            <div className="text-left">
              <p className="text-[10px] font-black text-hanoi-gold uppercase">
                Địa điểm hot nhất
              </p>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
            ...
            <>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tighter">
                    Gợi ý từ{' '}
                    <span className="text-hanoi-red italic">Trip4Hanoi</span>
                  </h2>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mt-24 mb-16 gap-6">
                <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tighter">
                    Các địa điểm{' '}
                    <span className="text-hanoi-red italic">phổ biến</span>
                  </h2>
                </div>
                <Link href="/explore">
                  <Button
                    variant="ghost"
                    className="text-hanoi-red font-black hover:bg-hanoi-red/5 rounded-2xl group text-lg"
                  >
                    Khám phá thêm{' '}
            ...
            <>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tighter">
                    Khám phá{' '}
                    <span className="text-hanoi-red italic">Hà Nội</span>
                  </h2>
                </div>
              </div>
              ...
              <div className="mt-16 text-center">
                <Link href="/explore">
                  <Button className="bg-zinc-900 hover:bg-hanoi-red text-white font-black px-10 h-16 rounded-2xl shadow-2xl transition-all">
                    Khám phá thêm hàng trăm địa điểm{' '}
        ...
        <div className="absolute top-40 left-10 opacity-[0.03] pointer-events-none select-none">
          <span className="text-[15vw] font-black italic tracking-tighter text-hanoi-red">
            HANOI
          </span>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tighter mb-8 leading-tight">
                ...
                <span className="text-hanoi-red italic">
                  khoảnh khắc Hà Nội
                </span>
              </h2>
              <div className="space-y-6 mb-10">
                <blockquote className="bg-white/50 backdrop-blur-md p-8 rounded-[32px] border border-hanoi-gold/30 shadow-xl relative">
                  <span className="absolute -top-6 left-8 text-8xl text-hanoi-gold font-serif opacity-50">
                    “
                  </span>
                  <p className="text-xl font-medium text-zinc-800 italic relative z-10">
                    Chưa bao giờ việc lên kế hoạch đi chơi Hà Nội lại dễ dàng
                    đến thế. AI của Trip4Hanoi gợi ý những quán cà phê thực sự
                    đúng gu mình!
                  </p>
  ...
  return (
    <section className="py-24 px-4 bg-white border-y border-hanoi-gold/20 overflow-hidden relative">
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-black text-zinc-900 tracking-tighter">
              Sự kiện đang{' '}
              <span className="text-hanoi-red italic underline decoration-hanoi-gold/50 underline-offset-8">
                diễn ra
              </span>
            </h2>
          </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-zinc-100 rounded-[40px] aspect-[4/5] animate-pulse"
              />
            ))}
          </div>
        ) : (
      ...
      <div className="absolute bottom-[-5%] right-[-5%] p-20 opacity-[0.02] pointer-events-none select-none">
        <span className="text-[25vw] font-black italic tracking-tighter text-hanoi-red leading-none">
          HANOI
        </span>
      </div>
    </section>
  ...
  return (
    <section className="py-24 px-4 bg-zinc-900 text-white overflow-hidden relative">
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
            Từ tour ẩm thực phố cổ đến hành trình văn hóa tâm linh, chúng tôi đã
            chuẩn bị sẵn những trải nghiệm tuyệt vời nhất cho bạn.
          </p>
        </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white/5 rounded-[40px] aspect-[4/5] animate-pulse"
              />
            ))}
          </div>
        ) : (
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(#F5E6CA 0.5px, transparent 0.5px)',
